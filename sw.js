...
const APP_SHELL = [
  ...
  './main.js',
  './manifest.json',
  'https://1dt57v2heibs3.space.minimax.io/assets/logo.svg',
  'https://1dt57v2heibs3.space.minimax.io/assets/icon-192.png',
  'https://1dt57v2heibs3.space.minimax.io/assets/icon-512.png',
  'https://1dt57v2heibs3.space.minimax.io/assets/icon-maskable.png',
  'https://1dt57v2heibs3.space.minimax.io/assets/apple-touch-icon.png',
